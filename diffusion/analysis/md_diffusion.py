...
def read_lammps_out(scandir, var=['x', 'y', 'z', 'temp'], time_unit='ns', t_skip=0, dt_step=1, dt_frame=1000, log=None):
    """
...
def read_position_array(simdir, directions=['x', 'y', 'z'], t_skip=0, log=None, save=None):
    """
    ...
    sim_data = read_lammps_out(simdir, var=directions, t_skip=t_skip, log=log)
